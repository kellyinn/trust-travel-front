            ...
            <div class="order fl">
              <div class="order-goods">
                <div class="goods-price">
                  <span class="new-price">￥{{this.infoData.totalPrice}}</span>
              ...
              <div class="order-subtotal">
                <div class="subtotal-item evenings-price clearfix">
                  <div class="fl">
                    <span>￥{{this.infoData.totalPrice}} x 1晚</span>
                  </div>
                  <div class="fr"><span>￥{{this.infoData.totalPrice}}</span></div>
                </div>
                ...
                <div class="subtotal-item clearfix">
                  ...
                  <div class="fr">
                    <span class="total-price">￥{{this.infoData.totalPrice}}</span>
                  </div>
                </div>
              </div>
              <div class="apply">
  ...
  <script>
    ...
    export default {
      ...
      methods: {
        ...
        async getDatail () {
          const {data} = await this.axios.get('http://47.94.249.31:8080/categoryList/'+ this.id);
          this.infoData = data;
