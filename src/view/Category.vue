      ...
      <div class="top">
        ...
        <div class="filter clearfix">
          <div class="left-btn fl">
            <el-row>
              <el-button  size="medium" class="big">日期</el-button>
    ...
    export default {
          ...
          events: {
            init (map) {
              AMapUI.loadUI(['overlay/SvgMarker', 'misc/PositionPicker', 'misc/MarkerList', 'overlay/SimpleMarker'], (SvgMarker, PositionPicker, MarkerList, SimpleMarker) => {
                ...
                // 加载数据
                function loadData () {
                  axios.get('http://47.94.249.31:8080/categoryList?_page=1&_limit=15').then((res) => {
                    // console.log(res);
      ...
      methods: {
        async getCategoryData () {
          const {data} = await this.axios.get('http://47.94.249.31:8080/categoryList?_page=1&_limit=15');
