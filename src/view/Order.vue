            ...
            <div class="right-info fl">
              <div class="order-info right-item">
                <div class="room-data clearfix">
                  <div class="text fl">
                      <div class="title">&nbsp;{{this.orderDate[0].hotel}}</div>
                ...
                <div class="number-time">
                  ...
                  <div class="number">
                    <span class="iconfont fl icon">&#xe607;</span>
                    <div class="fl">
                      <span>{{this.orderDate[0].roomType}}</span>
                    </div>
                  </div>
                </div>
                <div class="order-subtotal">
                  <div class="subtotal-item evenings-price clearfix">
                    <div class="fl">
                      <span>￥{{this.orderDate[0].totalPrice}} x 1晚</span>
                    </div>
                    <div class="fr"><span>￥{{this.orderDate[0].totalPrice}}</span></div>
                  </div>
                  ...
                  <div class="subtotal-item total clearfix">
                    ...
                    <div class="fr">
                      <span class="total-price">￥{{this.orderDate[0].totalPrice}}</span>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script>
    ...
    export default {
      ...
      methods: {
        ...
        getForm () {
          let orderData = this.orderDate[0];         
          var addr = sessionStorage.getItem('addr')
          addr = addr.replace("\"","").replace("\"","")
          console.log(addr)
          console.log(orderData.detailAddr)
          console.log(orderData.hotel)
          console.log(orderData.roomType)
          console.log(orderData.startTime)
          console.log(orderData.endTime)
          console.log(orderData.totalPrice)
          console.log(orderData.flag)

          var hotelOrder = {
                  "detailAddr": orderData.detailAddr,
                  "addr":addr,
                  "hotel": orderData.hotel,
                  "roomType": orderData.roomType,
                  "fromDate": orderData.startTime, 
                  "toDate": orderData.endTime, 
                  "ota": '携程',
                  "totalPrice": orderData.totalPrice,
                  "flag": orderData.flag
            }
         Vue.axios.post('http://47.102.216.199:3333/hotel',hotelOrder,{headers:{ "Content-Type": "application/json"}}).then((res) => {
